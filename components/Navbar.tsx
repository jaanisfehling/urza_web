        ...
        <>
            <div className="flex h-14 w-full px-4 items-center justify-between border-b-2 border-gray-700 dark:border-gray-700">
                ...
                <div className="relative flex">
                    <Link href={links[0].link} onClick={() => setShowSidebar(!showSidebar)} className="absolute top-2 right-0 z-10 lg:invisible px-2.5 rounded-sm text-2xl">{showSidebar ? "✖" : "☰"}</Link>
