...
export default function ArticleList({className, articleList, selectedArticle, setSelectedArticle, onLoadMoreClick}: {className?: string, articleList: Article[], selectedArticle: Article | null | undefined, setSelectedArticle: Dispatch<SetStateAction<Article | null | undefined>>, onLoadMoreClick: () => void}) {
    return (
